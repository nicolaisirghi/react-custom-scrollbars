...
var Scrollbars = function (_Component) {
    ...
    _createClass(Scrollbars, [{
        ...
        value: function setupDragging() {
            ...
            (0, _domCss2["default"])(doc.body, _styles.disableSelectStyle);
            doc.addEventListener('mousemove', this.handleDrag);
            doc.addEventListener('mouseup', this.handleDragEnd);
            doc.onselectstart = _returnFalse2["default"];
        }
    }, {
        key: 'teardownDragging',
        value: function teardownDragging() {
            var doc = this.view.ownerDocument;
            (0, _domCss2["default"])(doc.body, _styles.disableSelectStyleReset);
